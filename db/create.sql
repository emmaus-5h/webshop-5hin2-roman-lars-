...
insert into products (name, description, code, price, kwaliteit_id) values ('liverpool', 'liverpool thuis shirt 23/24.', '816905633-0', '99,99', 7);
insert into products (name, description, code, price, kwaliteit_id) values ('liverpool uit shirt', 'liverpool uit shirt 23/24.', '816905633-1', '99,99', 7);
insert into products (name, description, code, price, kwaliteit_id) values ('barcelona', 'barcalona thuis shirt 23/24.', '077030122-3', '99,99', 8);
insert into products (name, description, code, price, kwaliteit_id) values ('barcelona uit shirt', 'barcalona uit shirt 23/24.', '077030122-4', '99,99', 8);
insert into products (name, description, code, price, kwaliteit_id) values ('man united', 'manchester united thuis shirt 23/24.' ,'445924201-X', '99,99', 7);
insert into products (name, description, code, price, kwaliteit_id) values ('man united uit shirt', 'manchester united uit shirt 23/24.' ,'445924201-Y', '99,99', 7);
insert into products (name, description, code, price, kwaliteit_id) values ('psg', 'psg thuis shirt 23/24.', '693155505-7', '99,99', 10);
insert into products (name, description, code, price, kwaliteit_id) values ('psg uit shirt', 'psg uit shirt 23/24.', '693155505-8', '99,99', 10);
insert into products (name, description, code, price, kwaliteit_id) values ('bayern munchen', 'bayern munchen thuis shirt 23/24.', '492662523-7', '99,99', 9);
insert into products (name, description, code, price, kwaliteit_id) values ('bayern munchen uit shirt', 'bayern munchen uit shirt 23/24.', '492662523-8', '99,99', 9);
...
insert into  kwaliteit (cijfer, reden_cijfer) values ('8/10',' met de hand gemaakt door een groot bedrijf dat met goede kwaliteit werkt maar onder slechte omstandigheden.');
insert into  kwaliteit (cijfer, reden_cijfer) values ('9/10','met de hand gemaakt door professionals in de grootmarkt.');
insert into  kwaliteit (cijfer, reden_cijfer) values ('10/10','een 10 van de 10, heeft geen uitleg nodig!!!! alles is perfect.');
--1:n kwaliteit
